...
const InforCenterHome = () => {
    ...
    const textBuildOn = useBreakpointValue({ base: "24px", lg: "18px" });
    const widthBuildOn = useBreakpointValue({ base: "auto", lg: "142px" });
    ...
    return (
        <Flex flexDirection={"column"} width={"376px"} alignItems={"center"} gap={gapWrapper}>
            ...
            <Flex gap={"16px"} alignItems={"center"}>
                <Flex fontWeight={400} fontSize={textBuildOn} w={widthBuildOn}>Build on</Flex>
                {isSmallScreen ? (
